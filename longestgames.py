# Program for finding the longest games
...
sc = SparkContext("local", "Finding longest game length")
...
# Extract the top 50 longest games
topTenTuples = list(sortedRDD.takeOrdered(50, key=lambda x: -x[0]))
